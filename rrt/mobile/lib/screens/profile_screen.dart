...
class ProfileScreen extends StatefulWidget {
  ...
  const ProfileScreen({super.key, required this.onContinue});
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      setState(() {
        _saving = false;
        _error = 'Failed to save. Check backend and internet.';
      });
      return;
    }
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                ...
                'YOUR PHONE NUMBER IS EXPOSED ONLY WHEN AN SOS\n'
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: Center(
                          child: Text(
                            _saving ? 'SAVING...' : 'SAVE AND PROCEED',
                            style: const TextStyle(
                              fontSize: 16,
                              letterSpacing: 4,
                              fontWeight: FontWeight.w800,
